...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     *
     * @return get load more view position
     */
    @SuppressWarnings("WeakerAccess")
     ...
     * Call before {@link RecyclerView#setAdapter(RecyclerView.Adapter)}
     *
     * @param isHeadAndEmpty true means header empty
     * @param isFootAndEmpty true means footer empty
     */
    @SuppressWarnings("WeakerAccess")
     ...
     *
     * @param isUseEmpty true means use empty
     */
    ...
    /**
     * bind recyclerView {@link #bindToRecyclerView(RecyclerView)} before use!
     * Recommend you to use {@link BaseQuickAdapter#setEmptyView(int, ViewGroup)}
     *
