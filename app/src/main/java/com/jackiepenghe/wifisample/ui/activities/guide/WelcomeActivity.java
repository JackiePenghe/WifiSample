package com.jackiepenghe.wifisample.ui.activities.guide;
...
public class WelcomeActivity extends BaseWelcomeActivity {
    ...
    private WifiManager.RequestPermissionResult requestPermissionResult = new WifiManager.RequestPermissionResult() {
        ...
        public void requestSuccess() {
            doNormal();
            Tool.warnOut(TAG,"requestSuccess");
        }
        ...
        public void requestFailed() {
            ...
            Tool.warnOut(TAG,"requestFailed");
        }
        ...
        public void requestRationalCanceled() {
            doNormal();
            Tool.warnOut(TAG,"requestRationalCanceled");
        }
    };
